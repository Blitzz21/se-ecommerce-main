-- Drop the orders table if it exists and recreate it from scratch
-- to ensure it has all the correct columns and types
DROP TABLE IF EXISTS orders;

-- Create a completely new orders table with all required columns
CREATE TABLE orders (
